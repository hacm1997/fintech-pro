...
export const ContactContent = () => {
    return (
        <section className="bg-[#131212] mt-20 rounded-2xl">
            <div className="container px-6 py-12 mx-auto">
                <div>
                    <p className="font-medium text-blue-500 dark:text-blue-400">Contacto</p>

                    <h1 className="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">Información de contacto</h1>
                ...
                <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
                    <div>
                        ...
                        <p className="mt-2 text-blue-500 dark:text-blue-400">hacm1997@gmail.com</p>
                    </div>
